...
export default function PlaceGallery({place}){
          ...
          <div className="absolute inset-0 bg-white">
            <div className="p-8 grid gap-4">
                <div>
                    ...
                    <button onClick={() => setShowPhotos(false)} className="flex right-10 top-6 fixed gap-1 py-2 px-4 rounded-2xl shadow shadow-black">
    ...
    return (
        <div className="relative">
                ...
                <button onClick={() => setShowPhotos(true)} className="flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow-md shadow-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
